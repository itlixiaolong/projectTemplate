<template>
  <div>
    <tree v-if="functionsList.length" :dataList="functionsList" :options="options" :treeType="treeType" @backTreeData="emitTreeFun">
    </tree>
  </div>
</template>
...
import { getUserRightsTreeData, postUserRightAddFunctionsData, putUserRightUpdateFunctionsData, deleteUserRightDeleteFunctionsData } from 'api/userrights/index'
export default {
